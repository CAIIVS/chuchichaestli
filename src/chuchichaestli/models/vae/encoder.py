...
class DeepCompressionEncoderOutBlock(nn.Module):
    """Deep Compression-like output block for encoder.

    c.f. https://arxiv.org/abs/2410.10733
    """
...
ENCODER_OUT_BLOCK_MAP = {
    ...
    "DeepCompressionEncoderOutBlock": DeepCompressionEncoderOutBlock,
}
