...
AttnEncoderDownBlock = partialclass(
    "AttnEncoderDownBlock", EncoderDownBlock, attention="self_attention"
)
AttnEncoderMidBlock = partialclass(
    "AttnEncoderMidBlock", EncoderMidBlock, attention="self_attention"
)
AttnEncoderUpBlock = partialclass(
    "AttnEncoderUpBlock", EncoderUpBlock, attention="self_attention"
)
