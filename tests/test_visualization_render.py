...
def test_mermaid_mmd_export_is_utf8(tmp_path):
    ...
    code = (
        ...
        "m = VAE.build(dimensions=2, in_channels=3, latent_dim=4, out_channels=3,"
        " encoder_args=dict(n_channels=16, block_out_channel_mults=(1,),"
        " down_block_types=('AutoencoderDownBlock',), num_layers_per_block=1,"
        " mid_block_types=('AutoencoderMidBlock',)),"
        " decoder_args=dict(block_out_channel_mults=(1,),"
        " up_block_types=('AutoencoderUpBlock',), num_layers_per_block=1,"
        " mid_block_types=('AutoencoderMidBlock',)));"
